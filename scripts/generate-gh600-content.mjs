...
const questionSpecs = {
  ...
  D6: [
    ...
    },
    {
      ...
      trap: "任務成功率最有說服力，但它回答的是「多常出錯」；風險還要看出錯時有多嚴重、能不能撤回。",
      sources: ["GH600-SG"],
    },
    {
      type: "single",
    ...
    },
    {
      ...
      trap: "讓代理改寫指令再試看起來像自我修正，但被政策擋下的動作不該由代理自己找替代路徑，應該回報給人。",
    ...
    },
    {
      ...
      trap: "在 instructions 禁止修改也許能約束代理，但約束不了人和其他自動化，而且代理不一定遵守。",
